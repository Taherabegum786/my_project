...
UNITS = [
    ("I", "Block Chain and its History", [
        ...
        ("Blockchain Components – blocks, transactions, nodes, ledger, hashing and digital signatures", 2, "Lecture / Demonstration", "Compute SHA-256 hashes; observe the avalanche effect"),
        ("Permissioned Blockchain, Permissionless Blockchain and Consortium Blockchain", 1, "Lecture / Case Study", "Classify Hyperledger, Bitcoin, Ethereum and R3 Corda"),
    ...
    ("II", "Decentralization and Consensus Algorithms", [
        ("Decentralization using blockchain; Methods of decentralization – disintermediation, contest-driven", 1, "Lecture / Board", "Identify intermediaries removed by blockchain in given scenarios"),
        ("Routes to decentralization; Decentralized organizations – DOs, DAOs, DACs, DApps", 1, "Lecture / Case Study", "Study The DAO case and its lessons"),
        ("Distributed systems – CAP theorem, fault tolerance; Distributed ledger", 2, "Lecture / Worked Examples", "Compare centralized, decentralized and distributed ledgers"),
        ...
        ("Consensus Algorithms: Proof of Work – mining, difficulty, energy cost", 1, "Lecture / Demonstration", "Simulate mining with varying difficulty"),
        ("Proof of Stake and Proof of Burn", 1, "Lecture / Worked Examples", "Compare PoW, PoS and PoB on cost and security"),
        ("Proof of Elapsed Time, Proof of Activity and Proof of Concept", 2, "Lecture / Problem Solving", "Tabulate consensus algorithms; quiz on Unit II"),
    ]),
    ("III", "Bitcoin and Alternative Coins", [
        ("Bitcoin – overview, keys and addresses, wallets; Bitcoin transactions – inputs, outputs, UTXO", 2, "Lecture / Demonstration", "Trace a transaction on a block explorer"),
        ("Bitcoin payments; Bitcoin properties; Transaction life cycle", 1, "Lecture / Board", "Draw the transaction life cycle"),
        ...
        ("Double spending using blockchain; Bitcoin anonymity", 1, "Lecture / Think-Pair-Share", "Analyse a double-spend attack scenario"),
        ...
        ("Namecoin, Litecoin, Primecoin and Zcash", 2, "Lecture / Case Study", "Compare altcoins by purpose and consensus; quiz on Unit III"),
        ("Future currencies – CBDCs, stablecoins; creating own crypto token (ERC-20 overview)", 1, "Demonstration", "Outline the design of a custom token"),
    ]),
    ("IV", "Ethereum and Smart Contracts", [
        ("Ethereum Architecture – accounts, EVM, gas, transactions, blocks, networks", 2, "Lecture / PPT", "Explore accounts and gas on a test network"),
        ("Solidity programming basics – data types, variables, functions, modifiers, events", 2, "Demonstration / Hands-on", "Write simple Solidity programs in Remix IDE"),
        ("Smart Contract – structure, life cycle, security issues", 1, "Lecture / Worked Examples", "Write a simple storage and voting contract"),
        ("Deploying Smart Contracts – Remix, MetaMask, test networks, Ganache / Truffle", 2, "Demonstration / Hands-on", "Deploy a contract to a test network"),
    ...
    ("V", "Blockchain Applications", [
        ...
        ("Government and Health", 1, "Lecture / Case Study", "Discuss e-governance, land and health records"),
        ("Finance", 1, "Lecture / Case Study", "Study cross-border payments, trade finance and DeFi"),
        ("Media; Secure Voting and Digital Identity", 1, "Lecture / Think-Pair-Share", "Design a blockchain-based voting system"),
        ("Real Estate and Education", 1, "Lecture / Case Study", "Study land records and certificate verification; quiz on Unit V"),
    ]),
...
story += [
    ...
    Paragraph(f"<b>Course Type:</b> {SUBTITLE} &nbsp; | &nbsp; <b>Total Hours:</b> 45 (15 weeks × 3 hours)", BODY),
    Spacer(1, 3),
